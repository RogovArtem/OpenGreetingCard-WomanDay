...
document.addEventListener('click', _=>{
    ...
    tl
        ...
        .to(text, 1.5,  {x:'0%',delay:0.1}, 'slide')
    }
    if (counter===1){
    tl
        .to(text1, 0.3, {y:'-100%', display:'none'} )
        .to(text2, 0.3, {display:'flex', flexDirection:'column',justifyContent:'center',alignItems:'center', y:'0', delay:0.1})
    }
    if (counter===2){
    tl
        .to(text2, 0.3, {display:'none', y:'-100%'})
        .to(text3, 0.3, {display:'flex', flexDirection:'column',justifyContent:'center',alignItems:'center', y:'0', delay:0.1})
    ...
    .to(text3, 0.3, {display:'block', x:'-100%'}, 'steel')
    .to(hero, 2, {x:'-100%', width:'100%'}, 'steel')
    .to(overlay, 2, {width:'100%'},'steel')
    .to(overlay, 0.5, {width:0, left:0, delay:2}, 'steel')
    .to(newOne, 2, {display:'flex', flexDirection:'column',justifyContent:'center',alignItems:'center', width:'100%', opacity: 1, delay:3}, 'steel')
